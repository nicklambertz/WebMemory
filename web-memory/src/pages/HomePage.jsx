  ...
  return (
    <div className="min-h-screen flex flex-col items-center p-4 space-y-8">
      ...
      <button
        ...
        className="text-lg md:text-2xl bg-blue-500 text-white px-6 py-2 rounded hover:bg-blue-600 transition"
      >
      ...
      <div className="w-full max-w-screen-3xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {Object.entries(memorySets).map(([key, set]) => (
          ...
          >
            <div className="text-center text-base md:text-2xl font-semibold mb-2">
              {set.name}
            </div>
